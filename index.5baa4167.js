...
async function main() {
    ...
    function(localMediaStream) {
        ...
        video.addEventListener('canplay', async function(ev) {
            if (!streaming) // requestAnimationFrame(render);
            while(true){
                await render();
...
},{"./ar.js":"4Pk5T","@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8","os":"6yyXu","@tensorflow/tfjs":"fzTad"}],"6yyXu":[function(require,module,exports) {
